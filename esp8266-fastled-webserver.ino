...
// AP mode password
const char WiFiAPPSK[] = "Neni zadne heslo.";

// Wi-Fi network to connect to (if not in AP mode)
const char* ssid = "Jolanda";
const char* password = "matfyzboyz";
...
#define MILLI_AMPS         60000                                                            // IMPORTANT: set here the max milli-Amps of your power supply 5V 2A = 2000
...
void setup(void) {
  ...
  FastLED.addLeds<LED_TYPE, DATA_PIN>(leds, NUM_LEDS);         // for WS2812 (Neopixel)
